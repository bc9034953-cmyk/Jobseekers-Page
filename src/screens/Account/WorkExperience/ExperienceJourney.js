...
import UpsertExperienceModal from './UpsertExperienceModal';

const ExperienceJourney = forwardRef(({ userId }, ref) => {
  ...
  const params = {
    'ContentsSearch[type]': 'candidate_experiences',
